...
import argparse
from links import CollectLinks
import imghdr
import base64
...
class AutoCrawler:
    ...
    @staticmethod
    def get_keywords(keywords_file='flowername.txt'):
...
if __name__ == '__main__':
    ...
    print('Options - skip:{}, threads:{}, google:{}, full_resolution:{}, face:{}'.format(_skip, _threads, _google,_full, _face))

    crawler = AutoCrawler(skip_already_exist=_skip, n_threads=_threads, do_google=_google, full_resolution=_full, face=_face)
    crawler.do_crawling()
